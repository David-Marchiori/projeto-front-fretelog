      ...
      <div class="sidebar-top">
        ...
        <nav class="nav">
          <RouterLink to="/cotacao" class="nav-item">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M9 7H6a2 2 0 00-2 2v9a2 2 0 002 2h9a2 2 0 002-2v-3M9 7V5a2 2 0 012-2h2M9 7h6m0 0v2m0-2V5a2 2 0 012-2h0a2 2 0 012 2v3M9 12h6m-6 4h4"/></svg>
            Cotação de Frete
          </RouterLink>
...
.user-row { display: flex; align-items: center; gap: 10px; padding: 0 4px; margin-bottom: 12px; }
.avatar {
